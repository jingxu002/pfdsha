function [cf_,gof]=fit_fdpe_elli(com_xl,log_com_ddave)
...
st_ = [0.53902067269632659 0.43825481439478187 ];
ft_ = fittype('a*sqrt(1-4*(x-0.5)^2)+b',...
    'dependent',{'y'},'independent',{'x'},...
    'coefficients',{'a', 'b'});

% Fit this model using new data
[cf_ , gof ]= fit(x(ok_),y(ok_),ft_,'Startpoint',st_);
